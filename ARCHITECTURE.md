...
- **DB:** Migration **`0010_jobs_esign.sql`** adds **`jobs.esign_*`** columns. **`WorkOrderListJob.esign_status`** powers the work-orders list progress strip; detail shows a signature status timeline card.
